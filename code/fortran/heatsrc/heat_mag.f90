...
!  DATA THERM_COMP_CU, THERM_COMP_AL /1.D0, 1.D0/ 
  ...
  ! Do "B1" coil...
  !
  PRINT *,RAD_IN_A1,RAD_IN_A2,RAD_IN_A3
  PRINT *,RAD_OUT_A1,RAD_OUT_A2,RAD_OUT_A3
  X = XIN - X_B1
  Y = YIN - Y_B1
  Z = ZIN - Z_B1
